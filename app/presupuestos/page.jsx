...
export const metadata = {
  title: "Presupuesto y Servicios",
  description:
    "Soluciones tecnológicas para potenciar tu actividad profesional.",
  robots: {
    index: false,
    follow: false,
  },
...
const solutions = [
  {
    ...
    description:
      "Una página web profesional diseñada para que tus clientes te encuentren y confíen en vos.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Software creado para organizar tu trabajo y automatizar tareas repetitivas.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Servicio técnico integral para que tus herramientas de trabajo nunca fallen.",
    benefits: [
...
export default function PresupuestosPage() {
  return (
    <div className="w-full h-full min-h-full bg-base-100 rounded-2xl">
      <section className="flex flex-col items-center w-full max-w-6xl mx-auto px-4 py-12 gap-16">
        <header className="text-center max-w-2xl">
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight bg-gradient-to-r from-blue-500 via-indigo-400 to-cyan-400 bg-clip-text text-transparent">
            ¿Cómo puedo ayudarte?
          </h1>
          <p className="mt-6 text-xl text-base-content/70 leading-relaxed">
            Me especializo en crear herramientas digitales que simplifican tu
            día a día. Sin vueltas técnicas:{" "}
            <strong>soluciones que funcionan.</strong>
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
          {solutions.map((item, idx) => (
            <div
              key={idx}
              className="card bg-base-100 border border-base-300 rounded-2xl shadow-sm hover:border-primary hover:shadow-lg transition-all duration-300"
            >
              <div className="card-body p-8 gap-6">
                ...
                <div>
                  ...
                  <p className="text-base text-base-content/70 mt-2">{item.description}</p>
                </div>
                ...
                <div className="mt-auto pt-6">
                  <div className="bg-base-200 p-4 rounded-xl mb-6">
                    <p className="text-xs font-bold uppercase tracking-widest text-base-content/60 mb-1">
                      Resultado esperado
                    </p>
                    <p className="text-sm italic">&ldquo;{item.result}&rdquo;</p>
                  </div>
        ...
        <div className="max-w-4xl w-full grid grid-cols-1 sm:grid-cols-2 gap-8 items-center bg-base-200 p-8 sm:p-12 rounded-3xl border border-base-300">
          <div>
            <h3 className="text-3xl font-bold mb-4">Trabajemos juntos</h3>
            <p className="text-base-content/70">
              Mi objetivo es que te olvides de los problemas tecnológicos y te
              enfoques en lo que mejor sabés hacer. Entrego proyectos
              terminados, listos para usar y con soporte garantizado.
            </p>
          </div>
