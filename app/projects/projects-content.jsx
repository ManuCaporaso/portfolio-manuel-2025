...
const cards = [
  {
    ...
    description:
      "Sitio web institucional para el Sindicato de Trabajadores de la Prevención de Riesgos Laborales, Salud Ocupacional y Protección Ambiental de Neuquén y Río Negro. Enfoque en accesibilidad y comunicación gremial.",
  ...
  },
  {
    ...
    description:
      "Portfolio digital para estudio de arquitectura especializado en renders 3D. Optimización avanzada de carga de imágenes (WebP) y diseño responsivo de alta gama.",
  ...
  },
  {
    ...
    description:
      "Aplicación multiplataforma para capturar novedades de clientes en tiempo real. Incluye reconocimiento de imágenes para automatización de datos.",
  ...
  },
  {
    ...
    description:
      "Sistema de gestión administrativa para el sindicato municipal: manejo de afiliados, reportes de cuotas y paneles internos de control.",
  ...
  },
  {
    ...
    description:
      "Tienda online con flujo completo de compra: navegación por categorías, carrito de compras persistente y panel de administración.",
  ...
  },
  {
    ...
    description:
      "Sistema dinámico de turnos para comercios, utilizando comunicación bidireccional para actualizaciones instantáneas en pantalla.",
    ...
    <section className="flex flex-col items-center text-center w-full max-w-6xl mx-auto px-4 pt-4 pb-16 gap-10">
      <header>
        ...
        <p className="mt-2 text-base sm:text-lg text-base-content/70">
          Soluciones digitales a medida para organizaciones y estudios
          profesionales.
        </p>
      </header>
