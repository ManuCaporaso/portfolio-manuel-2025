...
const AboutPage = () => {
  ...
  return (
    <Layout title="About" description="Portfolio of Manuel Caporaso, Full Stack Developer.">
      {/* ↓↓↓ MENOS ESPACIADO ARRIBA ↓↓↓ */}
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8 text-left">
          ...
          <article className="card bg-base-100 border border-base-300 shadow-sm">
            <div className="card-body gap-4">
              ...
              Soy Técnico Superior en Desarrollo de Software Full Stack. Me formé para diseñar, desarrollar e implementar aplicaciones web y móviles completas, trabajando tanto en el frontend como en el backend. Manejo lenguajes de programación, bases de datos, servidores, API REST, control de versiones y diseño centrado en usabilidad. Poseo experiencia en análisis de requerimientos, modelado de datos, integración de servicios y despliegue de soluciones. Mi enfoque es código mantenible, comunicación clara y mejora continua orientada a resultados.
              </p>
            </div>
          </article>
          ...
          <article className="card bg-base-100 border border-base-300 shadow-sm">
            <div className="card-body gap-4">
              <h2 className="card-title">Habilidades técnicas</h2>
