  ...
  return (
    ...
    >
      ...
      <section className="flex flex-col items-center text-center gap-4">
        {/* Título superior */}
        <h2 className="text-lg sm:text-xl font-semibold uppercase tracking-widest text-primary dark:text-sky-400">
          Portfolio
        </h2>

        {/* Foto */}
        <div className="w-48 h-48 sm:w-60 sm:h-60 md:w-72 md:h-72 relative bg-gradient-to-br from-primary to-secondary dark:from-indigo-200 dark:to-sky-200 rounded-full overflow-hidden border border-base-300 shadow-lg transition duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-primary/25 dark:hover:shadow-indigo-400/25">
          <img
        ...
        {/* Nombre */}
        <h1 className="mt-4 text-4xl sm:text-6xl font-extrabold tracking-tight bg-linear-to-r from-primary to-secondary dark:from-indigo-300 dark:to-sky-400 bg-clip-text text-transparent">
          MANUEL CAPORASO
        </h1>
